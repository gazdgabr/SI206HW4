...
## SI 206 - W17 - HW4
## COMMENT WITH:
## Name: Gabriella Gazdecki
## Your section day/time: Thursday / 3-4
## Any names of people you worked with on this assignment:

#####################

## PART 1 (100 points) - Get the HTML data from https://www.nytimes.com (the New York Times home page) and save it in a file called nytimes_data.html.

## Write the Python code to do so here.
try:
	file = open("nytimes_data.html", "r")
	file_text = file.read()
	file.close()
